...
It is awareness of the direction that should guide local choices: the strategy, the customer promise, the constraints, and the priorities that matter most right now.
...
They remain the test for whether a new addition fits.
