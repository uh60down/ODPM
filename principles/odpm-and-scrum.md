...
The goal is for the team to agree on what exists — the Entities, Relationships, Actions, States, and Rules — before agreeing on what to build.
...
> Does this story reference established ontology entities, or does it introduce an undefined one?

An undefined entity is not a blocker. It is a Chase Understanding signal.

Resolve the entity first. Then write the story.
